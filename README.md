...
3. Inside this file enter your cron-schedule, like this e.g. to restart every day at 6:10 am: `10 6 * * * root docker restart -t 60  mc_valhelsia_3_minecraft_1 > /proc/1/fd/1 2>/proc/1/fd/2`
